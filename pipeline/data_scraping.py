...
class ScraperOrchestrator:
    def __init__(self, scraper_configs: List[Dict[str, Any]], output_dir: str = "dataset", append: bool = True):
        """
        ...
        # Define standardized filenames by category
        self.category_files = {
            'aluguel': {
    ...
    def run_scraper(self, scraper_config: Dict[str, Any]) -> pd.DataFrame:
        ...
        # Get category from params (aluguel or venda)
        category = params.get('category', '').lower()
        
        # If this is a recognized category (aluguel/venda), use standardized filenames
        ...
        # Merge common parameters with specific parameters
        # Specific parameters will override common ones if there's a conflict
...
def main():
    ...
    # Create orchestrator with scraper configurations
    ...
    # You can also run individual scrapers if needed
    # specific_scraper_config = scraper_configs[0]  # df_imoveis_aluguel
    # df = orchestrator.run_scraper(specific_scraper_config)
